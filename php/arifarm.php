...
<html>
    ...
    <body onload="start(IDscreen)" onresize="resize(IDscreen)">
		<div id="IDscreen">
            ...
            <div class="plantations" id="plantation2">
            ...
            <div class="plantations" id="plantation3">
            ...
            <br>
            <div class="plantations" id="plantation4">
            ...
            <div class="plantations" id="plantation5">
            ...
            <div class="plantations" id="plantation6">
